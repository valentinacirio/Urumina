...
if(isset($_SESSION['username'])){ //se la sessione e attiva
  $profilo="/urumina/urumina_homepage.php"; //la variabile profilo ci porta a urumina_homepage. In questo caso metto anche urumina/ cioe specifico il percorso perche urumina_homepage non si trova nella stessa cartella di questo file
}
?>
<!doctype html>
<html lang="it">
 ...
 <a href="<?php echo $profilo; ?>" style="text-decoration:none; color:inherit; cursor:pointer;">Urumina</a>
	...
	<div id="app" class="container-fluid">
		<div class="page-header">
			<h1 id="page-title">Le mie recensioni</h1>
		</div>
		<!--qui il contenuto della pagina che si riempie dinamicamnete tramite javascript-->
	...
	<script src="update-review.js"></script>
	<script src="delete-review.js"></script>
	<script src="search-review.js"></script>

	<script>    
		//funzione contenuta in read-reviews.js che mostra tutte le recensioni, senza questa funzione non si vedrebbe nulla
		showReviews(); 
	</script>
