...
// function cors() {
    ...
    //Il browser invia delle richieste OPTIONS (chiedono se puo fare le richieste vere e proprie (POST, PUT, ecc) e quali sono permesse)
    if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS') {
        if (isset($_SERVER['HTTP_ACCESS_CONTROL_REQUEST_METHOD'])) //se il browser chiede quali metodi sono permessi...
            header("Access-Control-Allow-Methods: GET, POST, OPTIONS"); //specifico che permetto metodi GET, POST e OPTIONS
